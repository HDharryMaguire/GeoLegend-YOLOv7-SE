...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='yolov7x-SE.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='tulineirong.yaml', help='data.yaml path')
