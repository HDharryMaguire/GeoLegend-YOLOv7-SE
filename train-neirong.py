...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='yolov7x.yaml', help='model.yaml path')
    ...
    parser.add_argument('--project', default='runs/train/neirong', help='save to project/name')
